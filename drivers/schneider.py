...
# CompatÃ­vel com Schneider M340
# Interface compatÃ­vel com app.py (osciloscÃ³pio)
...
# ==========================================================
# FUNÃ‡ÃƒO MODBUS BÃSICA
# ==========================================================
def read_mw(ip, register, tipo="INT", bit=None):
    """
    LÃª %MW via Modbus TCP.
    ...
    try:
        ...
        # Dados comeÃ§am apÃ³s MBAP + FC + bytecount
        data = resp[9:]
...
# ==========================================================
# THREAD DE LEITURA CONTÃNUA (chamada pelo app.py)
# ==========================================================
        ...
        for tag in tags:
            try:
                ...
                if tipo == "BOOL":
                    ...
                    valor = 1 if valor else 0   # BOOL â†’ nÃ­vel lÃ³gico
                else:
