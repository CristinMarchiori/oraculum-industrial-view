...
function CycleDetail() {
  ...
  return <div className="space-y-4">
    ...
    <Panel title="Gráfico do ciclo" subtitle={cycle.baseFile}><ScopeLegend mode="pressure" pressureUnit={machine?.pressureUnit} visible={visible} onToggle={() => undefined} /><Oscilloscope data={waveform} visible={visible} mode="pressure" pressureUnit={machine?.pressureUnit} height={350} /></Panel>
    <div className="grid gap-3 xl:grid-cols-2"><PeriodTable title="Períodos sob pressão" rows={cycle.pressurePeriods} pressure pressureUnit={machine?.pressureUnit} /><PeriodTable title="Alívios de pressão" rows={cycle.reliefPeriods} /></div>
